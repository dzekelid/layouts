...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/layouts/master/_listings/versapay/apis.md
...
- name: VersaPay API Reference - Import a CSV File
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/layouts/master/_listings/versapay/apiimports-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/layouts/master/_listings/versapay/apiimports-post-openapi.md
- name: VersaPay API Reference - Import a CSV File
  x-api-slug: apiimports-post
  description: |-
    When uploading a CSV-formatted file it???s helpful to use your language/framework tooling to simplify the [multipart/form-data](https://www.ietf.org/rfc/rfc2388.txt) file upload.
